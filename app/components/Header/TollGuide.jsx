    ...
    <div className="yellow-main grid gap-y-2 px-12 py-8 w-1/2 h-full rounded-lg hover:scale-105 tansition-transform duration-200 ease-in-out cursor-pointer" id="guide">
          ...
          <ol type="1" className="grid gap-y-2 w-full text-black-main text-left">
            <li><p className="flex w-full items-center text-base gap-x-4 text-justify text-lg">1. How to select source and destination?</p>
              <p>{"->"} To select source and destination drag the marker and place anywhere on the map to select source and destination, if country name is shown then there is no street address present in google geolocation api but it will still calculate the toll based on latitude and longitude of that location <b>OR</b> You can type address manually and select address from recommeded addresses and calculate toll.</p>
            </li>
